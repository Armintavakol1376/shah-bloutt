...
import CoffeeSloganSection from "../Components/PageCoffeTechnicsComponents/CoffeeSloganSection";
import CoffeeTechCategorySection from "../Components/PageCoffeTechnicsComponents/CoffeeTechCategorySection";
import CardsSections from "../Components/PageCoffeTechnicsComponents/CardsSections";
import QASections from "../Components/PageCoffeTechnicsComponents/QASections";
...
const page = () => {
  return (
    <ScreenWrapper>
      ...
      <NaviTab activeLink={"Choice of Coffee Maker"} />
      <ScreenContainer>
        <TransitionEffect1>
          <CoffeeSloganSection />
          <div style={{ width: 0, height: 0, display: "none" }}>
            <CoffeeTechCategorySection />
            <CardsSections />
          </div>
          <QASections />
        </TransitionEffect1>
      </ScreenContainer>
      <NaviBottom activeLink={"Choice of Coffee Maker"} />
    </ScreenWrapper>
  );
};
